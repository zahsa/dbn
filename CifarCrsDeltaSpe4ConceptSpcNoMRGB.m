...
load('cifarGrTrnEx','cifarGrTrnEx');%it's the same as cifarGrTrn
...
load('train.mat')
crsL3=find(coarse_labels==2);%flower category
crsL7=find(coarse_labels==6);%household furniture
...
for iter=1:max_iter
    iter
       ...
       loadName='CifarNWRBM_DN_hB_L3Gr600-1000-2000_maxEp400';
...
%     loadName='CifarNWGrRBM_DN_hBNat600-1000-2000_maxEp400.mat';
    ...
    loadName='CifarNWRBM_DN_hB_L3Gr600-1000-2000_maxEp400.mat';
    load(loadName);
    DN=CifarRBM;
...
netName='Gr600-1000-2000';
saveName=sprintf('NW_Jnt_SepSpcDeltaConf%s_MaxEpDelta%d',netName,max_epochs);
